...
знакомых:
<img width="1539" height="517" alt="image" src="https://github.com/user-attachments/assets/3e524353-9d50-4e37-b410-3eeaa633ae5c" />
...
Тогда учитывая `17M DAU`, получаем:

```azure
Трафик: 9.5 Мб * 17М / 86 400 = 1.98 Гб/c
RPS: 4670 * 17М / 86 400 = 973 000
```
